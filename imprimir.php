...
$ocorrencia = $getOcorrencias->getOcorrenciaById();
?>
...
<script src="partials/js/html2canvas.min.js"></script>
<script src="partials/js/jspdf.umd.min.js"></script>
...
<script>
    window.addEventListener('load', function() {
        ...
        html2canvas(element, {
            scale: 1, // Aumenta a escala para melhor resolução
